...
public class SettingController extends BaseController {
    ...
    public String setting(HttpServletRequest request) {
        ...
        Map<String, String> options = voList.parallelStream()
                .collect(Collectors.toMap(OptionVo::getName, OptionVo::getValue));
    ...
    public RestResponseBo saveSetting(@RequestParam(required = false) String site_theme, HttpServletRequest request) {
        try {
            ...
            Map<String, String> querys = parameterMap.entrySet()
                    .parallelStream()
                    .collect(Collectors.toMap(Map.Entry::getKey, t -> join(t.getValue())));
            //加锁保证系统和数据库中配置的一致性
